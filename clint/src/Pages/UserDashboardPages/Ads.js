...
const Ads = () => {
    ...
    const fetchAds = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8080/api/v1/ads/user-ads"
        );
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/api/v1/ads/create-user-ads",
        {
          adId: currentAd._id,
  ...
  return (
    <Layout>
      <div className="dashboard-container bg-light text-center py-4 p-5">
        <div className="d-flex justify-content-between align-items-center flex-wrap">
          <div>
            <h1 className="display-4 font-weight-bold">WATCH ADS</h1>
          </div>
          <div className="d-flex align-items-center">
            ...
            />
            <div
              className="mt-5 mb-5 p-5 bg-white rounded shadow"
            ...
            >
              ...
              <p className="text-muted mb-0">
                <span className="font-weight-bold">Total Earnings:</span>{" "}
                {loading ? (
                  <span>Loading...</span>
                ) : (
        ...
        {currentAd ? (
          <>
            ...
            <div className="ratio ratio-4x3 d-flex justify-content-center">
              <iframe
                ref={videoRef}
                src={`${currentAd.videoLink}?autoplay=20`}
                controls
                style={{
                  borderRadius: "10px",
                  border: "none",
